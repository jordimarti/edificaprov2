...
#Subcourse.create(course_id: 1, visible: true, name: "Introducción al estándar Passivhaus para climas cálidos - Español", link: "passivhaus_es", locale: "es", library_image: "https://s3-eu-west-1.amazonaws.com/edificapro/c01/c01_es.jpg")
#Subcourse.create(course_id: 1, visible: true, name: "Introduction to Passivhaus standard for warm climates - English", link: "passivhaus_en", locale: "en", library_image: "https://s3-eu-west-1.amazonaws.com/edificapro/c01/c01_en.jpg")
